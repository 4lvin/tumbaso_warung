...
class Repositories {
  ...
  Future lengkapiProfil(String email, String nama, String provinsiId, String kotaId, String kecId, String alamat,
          String longitude, String latitude, String telephone, String kurir, String token) =>
      apiProvider.lengkapiProfil(email, nama, provinsiId, kotaId, kecId, alamat, longitude, latitude, telephone, kurir, token);
  ...
  Future simpanProdukBarang(File file, String kategori, String subkategori, String nama, String harga, String satuan,
          String berat, String deskripsi, String keterangan, String minimum) =>
      apiProvider.simpanProdukBarang(file, kategori, subkategori, nama, harga, satuan, berat, deskripsi, keterangan, minimum);
